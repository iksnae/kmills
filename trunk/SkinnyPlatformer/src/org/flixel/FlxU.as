...
//		static public function collide2():Boolean
//		{
//			for (i = 0; i < objNum - 1; ++i) {
//				var s1:FlxSprite = objList[i];
//				  for (j = i + 1; j < objNum; ++j) {
//					    var s2:FlxSprite = objList[j];
//					    var r:Rectangle = VonG.getCollisionRect(s1, s2);
//					    if (r) {
//						      // collision reaction code goes here
//					    }
//				  }
//			}
//		}
